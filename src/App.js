                ...
                <div className='nodata'>
                  ...
                  {noData === 'Location Not Found' ? (
                    <>
                      ...
                      />
                      <p>Oh oh! Biz bu joyni topib kosmosda adashib qoldik.</p>
                    </>
                  ) : (
                    <>
                      <img
                      ...
                      <p style={{ padding: '20px' }}>
                        Xavotir olmang, agar nimani qidirishni bilmasangiz,
                        harakat qilib ko'ring: Dakka, Kanada yoki ehtimol AQSh.
                      </p>
                    </>
                  )}
                </div>
